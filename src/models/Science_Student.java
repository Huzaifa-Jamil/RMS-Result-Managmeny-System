...
public class Science_Student extends Student {

    // Data Members Encapsulates
    // No Data Members

    // Static Data Member
    static int totalScienceStudents = 0;

    // Setter Method
    public static void setTotalScienceStudents(int a) {
        totalScienceStudents = a;
    }

    // Getter Method
    public static int getTotalScienceStudents() {
        return totalScienceStudents;
    }

    // Argument constructor method With Authentaction
    public Science_Student(String a, String b, String c, Transcript d) {
        super(a, b, c, d);
        totalScienceStudents++;
    }

    // Zero Argument constructor method
    public Science_Student() {
        super();
        totalScienceStudents++;
    }
